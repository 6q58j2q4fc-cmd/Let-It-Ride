...
const productsData: Record<string, any> = {
  ...
  'pedego-tandem': {
    ...
    gallery: ['/images/products/pedego-tandem.jpg'],
  ...
  'pedego-cargo': {
    ...
    gallery: ['https://d2xsxph8kpxj0f.cloudfront.net/310519663234433834/JAjQFNXBbA5Quy72adLon7/pedego-cargo_911daa26.jpg'],
  ...
  'pedego-ridge-rider': {
    ...
    gallery: ['/images/products/pedego-ridge-rider.jpg'],
  ...
  'pedego-trail-tracker': {
    ...
    gallery: ['/images/products/pedego-trail-tracker.jpg'],
