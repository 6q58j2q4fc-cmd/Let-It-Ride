...
const products = [
  ...
  // Accessories Category
  {
    id: 13,
    slug: 'pedego-helmet',
    name: 'Pedego Safety Helmet',
    category: 'accessory',
    price: 79,
    salePrice: null,
    image: '/images/products/helmet.jpg',
    shortDescription: 'CPSC certified helmet with adjustable fit system. Available in multiple colors.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.8,
    specs: { weight: '350g', sizes: 'S/M/L', certification: 'CPSC' }
  },
  {
    id: 14,
    slug: 'abus-u-lock',
    name: 'ABUS Granit U-Lock',
    category: 'accessory',
    price: 129,
    salePrice: 99,
    image: '/images/products/lock.jpg',
    shortDescription: 'High-security U-lock with 14mm shackle. Includes mounting bracket for easy transport.',
    brand: 'ABUS',
    isFeatured: true,
    rating: 4.9,
    specs: { securityLevel: '15/15', shackle: '14mm', weight: '1.4 kg' }
  },
  {
    id: 15,
    slug: 'pedego-front-basket',
    name: 'Pedego Front Basket',
    category: 'accessory',
    price: 89,
    salePrice: null,
    image: '/images/products/basket.jpg',
    shortDescription: 'Durable wire basket with quick-release mounting. Perfect for groceries and gear.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.7,
    specs: { capacity: '15 lbs', dimensions: '14x10x9 in', mounting: 'Quick-release' }
  },
  {
    id: 16,
    slug: 'cygolite-metro-pro',
    name: 'Cygolite Metro Pro Light Set',
    category: 'accessory',
    price: 119,
    salePrice: null,
    image: '/images/products/lights.jpg',
    shortDescription: '1100 lumen front light + rear light combo. USB rechargeable with multiple modes.',
    brand: 'Cygolite',
    isFeatured: true,
    rating: 4.9,
    specs: { lumens: '1100', battery: 'USB rechargeable', runtime: '6 hours' }
  },
  {
    id: 17,
    slug: 'pedego-rear-rack',
    name: 'Pedego Rear Cargo Rack',
    category: 'accessory',
    price: 149,
    salePrice: null,
    image: '/images/products/rack.jpg',
    shortDescription: 'Heavy-duty aluminum rack with 55 lb capacity. Compatible with most Pedego models.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.8,
    specs: { capacity: '55 lbs', material: 'Aluminum', compatibility: 'Universal' }
  },
  {
    id: 18,
    slug: 'pedego-pannier-bags',
    name: 'Pedego Pannier Bags (Pair)',
    category: 'accessory',
    price: 159,
    salePrice: 129,
    image: '/images/products/panniers.jpg',
    shortDescription: 'Waterproof pannier bags with 40L total capacity. Easy clip-on mounting system.',
    brand: 'Pedego',
    isFeatured: true,
    rating: 4.8,
    specs: { capacity: '40L total', material: 'Waterproof', mounting: 'Clip-on' }
  },
  {
    id: 19,
    slug: 'pedego-phone-mount',
    name: 'Pedego Phone Mount',
    category: 'accessory',
    price: 39,
    salePrice: null,
    image: '/images/products/phone-mount.jpg',
    shortDescription: 'Universal phone mount with secure grip. Fits phones up to 6.7 inches.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.6,
    specs: { compatibility: 'Up to 6.7"', rotation: '360°', mounting: 'Handlebar' }
  },
  {
    id: 20,
    slug: 'pedego-mirror',
    name: 'Pedego Handlebar Mirror',
    category: 'accessory',
    price: 29,
    salePrice: null,
    image: '/images/products/mirror.jpg',
    shortDescription: 'Adjustable convex mirror for enhanced visibility. Easy handlebar installation.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.5,
    specs: { type: 'Convex', diameter: '3 in', mounting: 'Handlebar clamp' }
  },
  {
    id: 21,
    slug: 'pedego-fenders',
    name: 'Pedego Full Fender Set',
    category: 'accessory',
    price: 89,
    salePrice: null,
    image: '/images/products/fenders.jpg',
    shortDescription: 'Full coverage front and rear fenders. Keep dry on wet roads.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.7,
    specs: { coverage: 'Full', material: 'Plastic', compatibility: 'Most models' }
  },
  {
    id: 22,
    slug: 'pedego-battery-charger',
    name: 'Pedego Battery Charger',
    category: 'accessory',
    price: 149,
    salePrice: null,
    image: '/images/products/charger.jpg',
    shortDescription: 'Replacement/spare charger for Pedego batteries. Smart charging with auto shutoff.',
    brand: 'Pedego',
    isFeatured: false,
    rating: 4.9,
    specs: { type: 'Smart charger', output: '48V 2A', shutoff: 'Automatic' }
  }
];
