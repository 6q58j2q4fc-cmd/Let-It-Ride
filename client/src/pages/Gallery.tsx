...
const galleryImages = [
  ...
  {
    id: 6,
    src: '/gallery/cascade-mountains.jpg',
  ...
  {
    id: 8,
    src: '/gallery/deschutes-brewery.jpg',
  ...
  {
    id: 10,
    src: '/gallery/old-mill-river.jpg',
